        ...
        <form class="edit-form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="jurusan" name="jurusan" required>
                    ...
                    <option value="TBSM" <?= ($data['jurusan'] ?? '') == "TBSM" ? "selected" : "" ?>>TBSM</option>
                    <option value="TKRO" <?= ($data['jurusan'] ?? '') == "TKRO" ? "selected" : "" ?>>TKRO</option>
                    <option value="TP" <?= ($data['jurusan'] ?? '') == "TP" ? "selected" : "" ?>>TP</option>
                </select>
            </div>
